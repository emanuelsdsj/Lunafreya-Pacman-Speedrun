...
const string DFL_MAZE_PATH = MAZE_FOLDER + "originalLunafreya.lay";
...
//Lunafreya Changes
const int DFL_N_ROUNDS_POWERPILL = 55;
...
//Lunafreya Changes
const double DFL_REWARD_PILL = 11;
const double DFL_REWARD_POWERPILL = 10;
const double DFL_REWARD_KILL_GHOST = 250;
